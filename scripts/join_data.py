...
def get_coded_data(cases_df, case_ids, coded_feature_names):
    ...
    else: coded_feature_array = np.array([])
...
def construct_sparse_opinion_matrix(cases_df, opinion_data_dir,
    ...
    return sparse_feature_matrix, case_ids, valences,filtered_cases_df
...
def build_filenames_from_params(output_data_dir, num_shards, min_required_count,
    ...
    return feature_matrix_filename, case_ids_filename, cases_df_filename
...
def load_data(input_data_dir, output_data_dir,
    ...
    feature_matrix_filename, case_ids_filename,cases_df_filename = build_filenames_from_params(
    ...
    if os.path.isfile(feature_matrix_filename) and os.path.isfile(case_ids_filename) and os.path.isfile(cases_df_filename):
        ...
        print 'Data loaded from', feature_matrix_filename, 'and', case_ids_filename,'and',cases_df_filename
    else:
        ...
        # </HACK>
        sparse_feature_matrix, case_ids, valences,filtered_cases_df = construct_sparse_opinion_matrix(
    ...
    return sparse_feature_matrix, case_ids, valences, filtered_cases_df,parameters_dict
